frappe.pages['report_vg_003'].on_page_load = function(wrapper) {
...
MyPage = Class.extend({
	...
	init: function(wrapper) {
		this.page = frappe.ui.make_app_page({
			parent: wrapper,
			title: 'Salesmen Wise Sales Report 002',
			single_column: true
		});
...
function getapidata(){
	...
	// alert(a[0].value);
	frappe.call({
	method: "vgjewellry.VG_api.SalesmenSales_R002", //dotted path to server method
