frappe.pages['current-stock-admin'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: "Today's Stock (Admin Only)",
		single_column: true
	});
	// --- CSS Styling ---
	const style = `
	...
	frappe.call({
		...
		frappe.call({
                        ...
                        method: "vgjewellry.ideal_stock_api.get_current_stock_for_admin",
                        callback: function (r) {
