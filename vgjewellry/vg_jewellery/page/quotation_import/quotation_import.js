frappe.pages['quotation-import'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
        ...
        window.open('/api/method/vgjewellry.vg_jewellery.page.quotation_import.quotation_import.download_sample');
    });
    ...
    $('#upload_excel').click(function () {
        ...
        $.ajax({
            url: "/api/method/vgjewellry.quotation_import.upload_excel",
            type: "POST",
            data: form_data,
            processData:false,
            contentType:false,
