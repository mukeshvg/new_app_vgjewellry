...
def get_silver_margin_report_data():
    ...
    for uid, row in return_array.items():
        try:
            ...
            if existing_name:
                # ── UPDATE ──
                doc = frappe.get_doc("Silver Margin", existing_name)
                ...
                doc.fine_wt                   = float(row['fine_wt'] or 0)
                ...
                doc.purity        = float(row['purity'] or 0)
                ...
                doc = frappe.get_doc({
                    ...
                    "fine_wt":                float(row['fine_wt'] or 0),
